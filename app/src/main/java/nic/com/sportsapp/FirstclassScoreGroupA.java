...
public class FirstclassScoreGroupA extends AppCompatActivity
{
    RecyclerView frac;
    Toolbar toolbarfra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fr_groupa);

        frac=findViewById(R.id.FRarc);
        toolbarfra=findViewById(R.id.frgrpAtoolbar);
