...
public class WinnerAdapter extends FirebaseRecyclerAdapter<Detail,WinnerAdapter.myViewholder> {

    private Context context;

    public WinnerAdapter(@NonNull FirebaseRecyclerOptions<Detail> options, Context context) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull myViewholder holder, int position, @NonNull Detail model) {
        ...
        holder.relativeLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context.getApplicationContext(), WinnerList2.class);
    ...
    public myViewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new WinnerAdapter.myViewholder(v);
    }
    ...
    public class myViewholder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            if (getAdapterPosition() == 0) {
                intent = new Intent(context, WinnerList2.class);
